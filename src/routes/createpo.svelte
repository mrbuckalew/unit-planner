...
<h1>Add Program Operational Outcome</h1>
<form>
  ...
  <div class="textwrapper">
    <label for="po"
      >What significant functions, services, and/or procedures does the program
      intend to accomplish? (Program Operational Outcome)
    </label>
    <textarea cols="2" rows="10" name="po" />
  </div>

  <div class="textwrapper">
    <label for="assessment">
      What data supports the need for the Program Operational Outcome (Initial
      Assessment)?
    </label>
  ...
  <div class="textwrapper">
    <label for="plan">
      What is the action plan to achieve the program operational outcome?
    </label>
  ...
  <div class="textwrapper">
    <label for="budget"
      >Is there a budget amount required to complete the program operational
      outcome? If yes, what amount?
    </label>
